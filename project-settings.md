...
## Objective/Use-Case
Codebase onboarding agent that indexes a GitHub repository and answers natural language questions about the codebase. Users can ask "what does this repo do?", "how does auth work?", "where is the payment logic?" and get answers grounded in the actual source code with file citations.

## Local or Public Connection
Public (GitHub API, LLM APIs)

## Package Manager
pip / uv (Python)

## Visual Style
CLI-first (plain, functional)
...
- PyGitHub (repo access)
- Optional: tree-sitter (code parsing)
- Optional: Streamlit (UI in Week 4)
